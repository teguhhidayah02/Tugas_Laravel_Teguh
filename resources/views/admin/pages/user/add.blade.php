...
=======
		...
		<div class="card">
			...
			<div class="form-group form-label-group">
				...
				<label for="iName">Name</label>	
				@if($errors->has('name'))
				<div class="invalid-feeback">{{ $errors->first('name') }}</div>
				@endif	
			</div><!--End Form Group-->
			...
			<div class="form-group form-label-group">
				...
				<label for="iEmail">Email</label>
				@if($errors->has('email'))
				<div class="invalid-feeback">{{ $errors->first('email') }}</div>
				@endif	
			</div><!--End Form Group-->
			...
			<div class="form-group form-label-group">
				...
				<label for="iPassword">Password</label>
				@if($errors->has('password'))
				<div class="invalid-feeback">{{ $errors->first('password') }}</div>
				@endif
			</div><!--End Form Group-->
			...
			<div class="form-group form-label-group">
				...
				<label for="iRePassword">Re Password</label>
				@if($errors->has('repassword'))
				<div class="invalid-feeback">{{ $errors->first('repassword') }}</div>
				@endif
			</div><!--End Form Group-->
			...
			<div class="form-group form-label-group">
				...
				<select class="form-control {{ $errors->has('akses')?'is-invalid':'' }}" name="akses">
					<option value="" {{ $val==""?'selscted':'' }}>Pilih Akses Sebagai : </option>
					<option value="operator" {{ $val=="operator"?'selscted':'' }}>Operator</option>
					<option value="admin" {{ $val=="admin"?'selscted':'' }}>Administrator</option>	
				</select>
				@if($errors->has('akses'))
				<div class="invalid-feeback">{{ $errors->first('akses') }}</div>
				@endif
			</div><!--End Form Group-->
